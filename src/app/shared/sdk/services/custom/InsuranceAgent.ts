...
/**
 * Api services for the `InsuranceAgent` model.
 */
@Injectable()
export class InsuranceAgentApi extends BaseLoopBackApi {
  ...
  public getAccessTokens(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/InsuranceAgents/:id/accessTokens";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/InsuranceAgents/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.InsuranceAgent#getCurrent
   * @methodOf sdk.InsuranceAgent
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/InsuranceAgents" + "/:id";
   ...
   * call to {@link sdk.InsuranceAgent#login} or
   * {@link sdk.InsuranceAgent#getCurrent}. Return null when there
   ...
   * call to {@link sdk.InsuranceAgent#login}
   *
  ...
  /**
   * @name sdk.InsuranceAgent#isAuthenticated
   *
  ...
  /**
   * @name sdk.InsuranceAgent#getCurrentId
   *
