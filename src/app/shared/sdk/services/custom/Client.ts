...
export class ClientApi extends BaseLoopBackApi {
   ...
   *  - `verified` – `{boolean}` - 
   */
  public verifiedEmail(clientId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Clients/verifiedEmail";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   *  - `verified` – `{boolean}` - 
   */
  public resendVerificationEmail(clientId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Clients/resendVerificationEmail";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof clientId !== 'undefined' && clientId !== null) _urlParams.clientId = clientId;
