...
/**
 * Api services for the `Applicant` model.
 */
@Injectable()
export class ApplicantApi extends BaseLoopBackApi {
  ...
  /**
   * accessTokens consultas de Applicant.
   *
   * @param {any} id Applicant id
   *
   * @param {object} filter 
  ...
  /**
   * Recuentos accessTokens de Applicant.
   *
   * @param {any} id Applicant id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Applicants/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `exists` – `{boolean}` - 
   */
  public existsEmail(email: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Applicants/existsEmail";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.Applicant#getCurrent
   * @methodOf sdk.Applicant
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Applicants" + "/:id";
   ...
   * call to {@link sdk.Applicant#login} or
   * {@link sdk.Applicant#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Applicant#login}
   *
  ...
  /**
   * @name sdk.Applicant#isAuthenticated
   *
  ...
  /**
   * @name sdk.Applicant#getCurrentId
   *
